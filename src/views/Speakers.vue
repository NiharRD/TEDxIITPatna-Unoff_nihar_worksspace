<template>
  ...
  <div class="theme-bg">
    ...
    <div class="year-bar" ref="yearBar" :class="{ sticky: isSticky }">
      <div
        class="year"
        v-for="year in [2025, 2024, 2023, 2022, 2021, 2019]"
        :key="year"
...
export default {
  ...
  data() {
    return {
      ...
      expandedYears: [2025], // show only 2024 by default on mobile
      isMobile: false,
      isSticky: false,
      ...
      allYears: [
        ...
        },
        {
          ...
          speakers: [
            ...
            { name: 'Vivek Ram', image: require('@/assets/images/vivek.png'), title: 'Question Everything?', description: 'Vivek Ram is a digital artist and storyteller whose work in animation and visual design spans global studios and independent projects. Known for blending Indian mythological themes with contemporary aesthetics, he creates worlds that inspire wonder.', youtubeLink: 'https://youtu.be/bG4VLt6uVUc', youtubeButton: true },
