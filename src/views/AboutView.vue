    ...
    <div class="white-border-box">
      <div class="coordinators-row-normal">
        <div class="coordinator">
          ...
          <p>Lohitaksha Guha</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Design</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
        ...
        <div class="coordinator">
          ...
          <p>Ishika Gupta</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Planning and Curation</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
    ...
    <div class="white-border-box">
      <div class="coordinators-row-normal">
        <div class="coordinator">
          ...
          <p>Aman Arora</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Marketing and<br>Sponsorship</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
        ...
        <div class="coordinator">
          ...
          <p style="font-weight: normal; font-size: 0.9rem;">Production</p>
        </div>
      </div>
    </div>
    ...
    <div class="white-border-box">
      <div class="coordinators-row-normal">
        ...
        <div class="coordinator">
          ...
          <p>Abhay Varshney</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Registration, Security<br>and Planning</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
        ...
        <div class="coordinator">
          ...
          <p>Devasish Vaddi</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Hospitality</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
    ...
    <div class="white-border-box">
      <div class="coordinators-row-normal">
        <div class="coordinator">
          ...
          <p>Naitik</p>
          <p style="font-weight: normal; font-size: 0.9rem;">Web Development</p>
        </div>
        <div class="coordinator">
          <div class="image-wrapper">
